...
function abreAjuda(){
  ...
  abreModal(`
    ...
    <details class="help-sec"><summary>TODAS as telas (por área do Dexterity Hub — clique para abrir)</summary><div class="help-body">
      ...
      <li>· <span class="lnk" data-aj-goto="agenda"><b>📅 Agenda</b></span> — eventos do Outlook viram ticket de reunião (projeto à escolha ou vínculo), com convites de apontamento ao time interno e o painel 🎫 Controle de tickets separado por responsabilidade (⚠ com você · ⏳ com colegas que não criaram · ✓ com ticket · 🚫 ignoradas), conferência no Jira e 📨 cobrança pelo Inbox.<button class="aj-g" data-aj-guia="agenda">🧭 guia</button></li>
      ...
      <li>· <span class="lnk" data-aj-goto="projetos"><b>📁 Projetos</b></span> — BI por projeto direto do Jira, com drill-down total; a ficha é a 🦴 espinha do app (7 chips: Contrato · Parceria · Plano · Cronograma · Execução · Apuração · Resultado) e cada tela do outro lado tem o botão 📁 para voltar.<button class="aj-g" data-aj-guia="projetos">🧭 guia</button></li>
      ...
      <li>· <span class="lnk" data-aj-goto="uso"><b>📊 Uso do painel</b></span> — como o time usa o Dexterity Hub: quem abre qual tela, quantas vezes e por quanto tempo, por dia, por pessoa e por aparelho — e as telas que ninguém abriu. Cada pessoa vê o próprio uso; o consolidado é de gestores e diretoria.<button class="aj-g" data-aj-guia="uso">🧭 guia</button></li>
    ...
    <details class="help-sec"><summary>Agenda (Outlook → ticket) e o controle de tickets</summary><div class="help-body">
      ...
      clique e o worklog sai no usuário da pessoa. O painel <b>🎫 Controle de tickets</b> separa por
      <b>responsabilidade</b>: <b>⚠ dependem de você</b> (com as que <b>já aconteceram</b> num bloco recolhido),
      <b>⏳ aguardando quem organizou</b> — colegas da Dexterity que te convidaram e não criaram o ticket, com
      <b>quantas horas suas</b> estão sem onde apontar, <b>📨 cobrar</b> (uma ou todas de uma vez) e
      <b>📝 criar assim mesmo</b> quando não dá para esperar — e, recolhidos, <b>✓ com ticket</b> e
      <b>🚫 ignoradas</b>. Confere no <b>Jira</b> se já existe ticket criado fora do app ("🟡 achei no Jira" →
      <b>✓ usar este ticket</b>). Reunião que nunca vira apontamento (bloqueio de agenda, all-hands) sai da
      cobrança com <b>🚫 ignorar</b> — se for recorrente, a série inteira — e volta quando você quiser.
...
const TOUR_TELAS=[
  ...
  {vai:'agenda',titulo:'📅 Agenda (Outlook → ticket)',texto:'Seus eventos do Outlook viram tickets de reunião: crie no projeto certo ou vincule a um ticket existente e convide os participantes internos para apontar. O painel 🎫 Controle de tickets separa o que depende de VOCÊ do que está com colegas que convidaram e não criaram o ticket (com as horas suas sem onde apontar, 📨 cobrar e 📝 criar assim mesmo), recolhe o que já tem ticket e deixa 🚫 ignorar o que nunca vira apontamento.'},
  ...
  {vai:'projetos',titulo:'📁 Projetos',texto:'BI por projeto direto do Jira: ficha completa com épicos, saúde, equipe, horas e drill-down até o ticket — e todo drill (idade do backlog, vencimentos, responsável…) tem o 🛠 Abrir na Gestão, que leva os tickets já selecionados para agir em massa. A ficha é a 🦴 espinha do app: os chips Contrato · Parceria · Plano · Cronograma · Execução · Apuração · Resultado abrem a tela da outra área já neste projeto, e cada uma delas tem o botão 📁 para voltar à ficha.'},
...
const GUIAS={
  ...
  agenda:{t:'📅 Agenda (Outlook → ticket)',p:[
    ...
    {c:'🎫 Controle de tickets',ti:'🎫 Controle de tickets',tx:'Separado por responsabilidade: ⚠ dependem de você (as já passadas ficam recolhidas, com "ignorar todas"), ⏳ aguardando quem organizou, e — recolhidos — ✓ com ticket e 🚫 ignoradas. O painel confere no Jira ("🟡 achei no Jira" → ✓ usar este).'},
    {s:'#conteudo [data-ag-cobrar-todos]',ti:'⏳ O que está com os colegas',tx:'Convite de alguém da Dexterity que não criou o ticket? Aqui aparece quantas horas SUAS estão sem onde apontar. 📨 cobra todo mundo de uma vez (vai para o 📥 Inbox de cada organizador) e, se não der para esperar, 📝 criar assim mesmo resolve na hora.',quando:'Aparece quando um colega deixar uma reunião sua sem ticket.'},
    {s:'#conteudo [data-ag-ignorar]',ti:'🚫 Ignorar o que não vira ticket',tx:'Bloqueio de agenda, all-hands, convite em massa: 🚫 ignorar tira a reunião da cobrança aqui, no card do Início e no Fechamento do mês — se ela for recorrente, a série inteira sai. Nada muda no Outlook nem no Jira, e o bloco 🚫 Ignoradas devolve com ↩ voltar a cobrar.'}]},
  inbox:{t:'📥 Inbox',p:[
  ...
  projetos:{t:'📁 Projetos',p:[
    ...
    {s:'#conteudo .proj-espinha',ti:'🦴 Espinha do projeto',tx:'Da ficha, um clique abre a tela da outra área já neste projeto: 📑 Contrato (Clientes), 🤝 Parceria (o contrato da consultoria em destaque), 💹 Plano (Rentabilidade — cria um plano novo se ainda não houver; mostra a ordem de venda do Odoo), 📅 Cronograma (marcos dos épicos), 🛠 Execução (Tickets do time filtrados), 🛡 Apuração (AMS por ciclo ou bolsa de horas) e 🏦 Resultado (Controladoria com o 📁 Resultado do projeto aberto). Chips de áreas fora do seu perfil ficam em cinza, mas abrem — e do outro lado o botão 📁 traz de volta.',quando:'Aparece ao abrir a ficha de um projeto.'},
  ...
  uso:{t:'📊 Uso do painel',p:[
    {c:'📊',ti:'Para que serve',tx:'Esta tela responde "como o meu time usa o painel": <b>quem abre qual tela, quantas vezes e por quanto tempo</b>. Serve para decidir o que evoluir, o que ensinar e o que aposentar — não para vigiar ninguém. Cada pessoa enxerga o próprio uso; o consolidado do time é de gestores e diretoria.'},
    {s:'#conteudo .ap-filtros',ti:'O período',tx:'Últimos 7, 14, 30, 60 ou 90 dias. A contagem começou no dia em que esta tela entrou no ar — ela não reconstrói o passado.'},
    {s:'#conteudo .kpis',ti:'O retrato do período',tx:'Quantas pessoas usaram, quanto tempo somado, quantas aberturas de tela e quantas telas diferentes foram abertas.'},
    {s:'#conteudo .uso-mini',ti:'Por dia e por aparelho',tx:'A curva mostra os minutos de uso a cada dia (e quantas pessoas entraram). Ao lado, quanto do tempo é <b>computador</b> e quanto é <b>celular</b> — útil para decidir onde vale investir no layout.'},
    {s:'#conteudo .uso-tab',ti:'🏆 Telas mais usadas',tx:'Ordenadas pelo <b>tempo</b>, não pelo clique: a abertura conta a visita, o tempo conta o proveito. Uma tela com muitas aberturas e pouco tempo costuma ser passagem (ou confusão); muito tempo e poucas aberturas é onde o trabalho acontece.'},
    {s:'#conteudo [data-uso-pessoa]',ti:'👥 Por pessoa',tx:'Quanto tempo cada um passou, em quantas telas e qual é a tela dele. Clique no nome para abrir o detalhe com as telas ranqueadas.',quando:'Só para gestores, negócio, diretoria e admin.'},
    {s:'#conteudo .uso-chips',ti:'🕸 Ninguém abriu',tx:'As telas do catálogo que ninguém abriu no período — candidatas a sair do menu. Antes de aposentar, confira se a tela é sazonal (fechamento do mês, apuração) e se quem precisa dela tem o papel para enxergá-la.'},
    {c:'🔒',ti:'O que fica guardado',tx:'Só <b>quem · qual tela · quantas aberturas · quantos segundos · que dia · celular ou computador</b>. Nenhum ticket, texto ou filtro. O relógio só conta com a aba à frente e para depois de 5 minutos sem interação. O histórico é podado depois de 180 dias.'},
  ]},
  ...
  cronograma:{t:'📅 Marcos e Cronograma',p:[
    {s:'#cr-proj',ti:'Escolha o projeto',tx:'O cronograma é montado a partir da ficha do projeto no Jira: cada épico vira uma fase. Chegando pela ficha do projeto ou pela Central (R04), o projeto já vem escolhido — e, pela Central, a lista traz só os projetos dos tipos onde o R04 é O ou R.'},
    {s:'#conteudo .vg-hero',ti:'Os números do projeto — clicáveis',tx:'Épicos por status, atrasados, em risco, marcos nos próximos 30 dias, progresso geral em itens e o último marco planejado contra a previsão pelo ritmo. Clique em Atrasados, Em risco ou Marcos em 30 dias para filtrar o cronograma (clique de novo para voltar a todos); Progresso geral abre os itens por épico e os abertos; Último marco abre o épico daquele marco.',quando:'Aparece quando a ficha do projeto termina de carregar.'},
    {s:'#conteudo .cr-gantt',ti:'O cronograma em cascata',tx:'Barra clara = planejado (Data de início → Data limite do épico); barra colorida = real (1º item criado → último concluído, ou até hoje) com o % de itens; ◆ marco (vermelho se passou); ▲ previsão pelo ritmo; linha tracejada = hoje; setas = dependências "blocks". Clique numa linha para abrir o épico.',quando:'Aparece quando a ficha do projeto termina de carregar.'},
    {s:'#conteudo [data-cr-fil]',ti:'Filtros, ordem e escala',tx:'Mostre todos, só os abertos, os atrasados e em risco ou os concluídos; ordene em cascata (número da fase e início), por início, marco, status ou nome; escala semanal ou mensal.',quando:'Aparece quando a ficha do projeto termina de carregar.'},
    {s:'#conteudo .cr-tab',ti:'Marcos e status por épico',tx:'Datas planejadas × reais, atraso em dias, itens, horas, dependências e alertas. Marco com * vem do maior vencimento dos filhos (o épico não tem Data limite).',quando:'Aparece quando a ficha do projeto termina de carregar.'},
    {s:'#conteudo .mtp-lista',ti:'Os dados permitem ler o cronograma?',tx:'Épicos sem datas, itens vencendo depois do marco, épicos concluídos com itens abertos e dependências invertidas — o que preencher no Jira para o cronograma ficar confiável.',quando:'Aparece quando há alertas de qualidade dos dados.'},
    {ti:'O detalhe do épico',tx:'Clicando numa linha: burn-up (itens criados × concluídos acumulados por mês), horas apontadas por mês (Clockwork, 12 meses), a composição com os itens abertos primeiro e a ação de abrir os abertos na Gestão.'}]},
  meutempo:{t:'⏳ Como estou gastando meu tempo?',p:[
    {s:'#mtp-de',ti:'Escolha o período',tx:'Todos os apontamentos da pessoa entre as datas (até 1 ano): de/até ou atalhos de mês, 3, 6 e 12 meses.'},
    {s:'#conteudo .card > .vg-hero',ti:'Os números do período',tx:'Horas, dias com apontamento, faturável, tickets tocados, a nota de qualidade dos dados e quantos apontamentos têm comentário.',quando:'Aparece quando as horas do período terminam de carregar.'},
    {s:'#conteudo .mtp-cols',ti:'Como o dia funciona',tx:'Horas por hora do dia e por dia da semana, tamanho dos apontamentos e troca de contexto (tickets e projetos por dia).',quando:'Aparece quando as horas do período terminam de carregar.'},
    {s:'#conteudo .barlist',ti:'Onde vai o tempo',tx:'Por tipo de ticket, projeto, categoria e épico, com evolução semanal. Clique numa barra para ver os tickets por trás.',quando:'Aparece quando as horas do período terminam de carregar.'},
    {s:'#conteudo .mtp-nuvem',ti:'O que dizem os apontamentos',tx:'Os comentários classificam a natureza do trabalho (reunião, desenvolvimento, suporte…) e mostram as palavras mais frequentes e amostras.',quando:'Aparece quando há comentários nos apontamentos.'},
    {s:'#conteudo .rp-wf',ti:'Os dados permitem uma boa análise?',tx:'Uma nota de 0 a 100 diz se os registros têm detalhe suficiente: comentários, épicos, tickets específicos, granularidade e horário. Com os problemas e como melhorar.',quando:'Aparece quando as horas do período terminam de carregar.'},
    {s:'#conteudo [data-mtp-ia]',ti:'Análise por IA',tx:'Envia os números agregados e amostras de comentários e devolve o retrato do período, como o dia funciona, onde o tempo vai, colaboração, qualidade dos dados e recomendações.',quando:'Aparece quando as horas do período terminam de carregar.'}]},
  rentab:{t:'💹 Rentabilidade de projetos',p:[
    {s:'#conteudo [data-rp-novo]',ti:'Cadastre o projeto e o tipo',tx:'Projeto do Jira (obrigatório — a categoria sugere o tipo), início e fim, e o modelo de receita: ⏱ horas abertas (🤝 contrato de parceria, horas por dia útil e valor da hora), 📦 escopo fechado (valor do projeto e marcos de faturamento) ou 🏠 interno (orçamento de custo).',quando:'Aparece para gestores na lista de planos.'},
    {s:'#conteudo .rp-marcos',ti:'Marcos de faturamento',tx:'No escopo fechado: quando e quanto do valor é faturado (data, %, épico do Jira). Marque ✓ faturado ao emitir a nota; a curva mostra faturamento × custo acumulados.',quando:'Aparece num plano de escopo fechado.'},
    {s:'#conteudo .rp-grade tr.rp-f-vend',ti:'✎ Horas vendidas — digite o mês que não fecha pela conta',tx:'A linha <b>Horas vendidas</b> nasce da carga por dia útil × os dias úteis do mês, mas <b>cada mês aceita o número que você digitar</b> — férias coletivas, um mês em que o cliente comprou menos, o começo no meio do mês. O calculado não some: fica logo abaixo ("calc. 168h") e o total mostra os dois lados. Apague o campo para voltar ao automático, ou use o <b>↺</b> ao lado da receita para devolver o plano inteiro. O que você digita vale para <b>tudo</b>: receita do mês, eficiência, saldo, períodos de faturamento (e os itens da ordem no Odoo) e o realizado × previsto. Enter e as setas andam pelos meses.',quando:'Só gestores editam; os demais veem o número com o selo ✎ e o cálculo no tooltip.'},
    {s:'#conteudo .rp-rec',ti:'Precisão de receita',tx:'Nas horas abertas: receita prevista mês a mês (horas vendidas do mês × valor da hora) contra a realizada (horas faturáveis apontadas × valor).',quando:'Aparece num plano de horas abertas.'},
    {s:'#conteudo .rp-per-tab',ti:'Períodos de faturamento',tx:'A receita quebrada nos períodos do 🤝 contrato de parceria ("até o dia 25" = de 26 a 25, nota no dia combinado; datas ajustáveis mês a mês no contrato) ou no mês civil. A coluna Odoo diz se o item está na cotação, faturado ou pago.',quando:'Aparece num plano de horas abertas.'},
    {s:'#conteudo [data-rp-odoo]',ti:'Ordem de venda no Odoo',tx:'Cria no módulo de Vendas do Odoo uma cotação em rascunho com UM ITEM POR PERÍODO de faturamento (horas previstas × valor da hora) no cliente do plano — a equipe confirma e fatura lá.',quando:'Aparece para gestores num plano de horas abertas com receita e sem ordem vinculada.'},
    {s:'#conteudo [data-rp-odoo-sync]',ti:'Sincronizar com o Odoo',tx:'Lê a ordem no Odoo: estado, o que já foi faturado de cada item e as faturas (número, data, pago/em aberto). Os períodos mudam de status sozinhos e o histórico registra. Acontece ao abrir o plano (a cada 10 min) ou pelo ↻.',quando:'Aparece quando o plano já tem uma ordem de venda no Odoo.'},
    {s:'#conteudo .rp-hist',ti:'Histórico do plano',tx:'Quem gravou/alterou o quê e quando: dados campo a campo (antes → depois), cenários, alocação, marcos, simulador e Odoo. Alterações seguidas do mesmo tipo viram um registro com contador.',quando:'Aparece com um plano aberto que já teve alguma gravação.'},
  ...
  controladoria:{t:'🏦 Controladoria de Projetos',p:[
    ...
    {s:'#conteudo [data-ct-cat-ir]',ti:'🧭 Todas as categorias',tx:'Receita, custo e margem de cada categoria lado a lado, com as mesmas regras — clique numa linha para abrir a categoria.',quando:'Aparece quando houver horas em mais de uma categoria no período.'},
    ...
    {s:'#ct-res',ti:'📁 Resultado do projeto',tx:'Um projeto em foco (🧾 na linha do projeto, ou o chip 🏦 Resultado da ficha): horas, receita, custo e margem do período; custo por nível (Júnior/Pleno/Sênior) e por pessoa; vendido × realizado do contrato; plano de rentabilidade × realizado; evolução mensal. Os botões levam à ficha, ao plano, às Métricas do tipo e ao contrato.',quando:'Aparece com um projeto em foco — clique no 🧾 de uma linha da tabela de projetos.'},
  ...
  parcerias:{t:'🤝 Contratos de parceria',p:[
    ...
    {s:'#conteudo .pc-eq-grade tbody tr:nth-child(2) .pc-prev-c',ti:'✎ Digite por cima quando o mês for negociado',tx:'Nem todo mês fecha pela conta. Clique em <b>Horas</b> ou em <b>Valor</b> e escreva o número combinado — ele passa a valer e o calculado fica logo abaixo ("calc. 160h"), para a diferença ficar sempre à vista. Só as <b>horas</b>? O valor acompanha (horas × valor-hora). Um <b>valor fechado</b>? Escreva no Valor. Para voltar ao automático, apague o campo ou use o <b>↺</b> no fim da linha. As colunas de cada pessoa continuam mostrando o que os trechos dizem — por isso elas podem não somar o total ajustado. Tudo fica no histórico do contrato.',quando:'Só gestores editam; os demais veem o número com o selo ✎.'},
    {s:'#conteudo [data-pc-fat]',ti:'🧾 Faturamentos — a ordem de venda no Odoo',tx:'O cockpit de cada nota: uma linha por período de faturamento (horas, valor, extras, total da nota, objetos de resultado, data da nota e o estado no Odoo). O botão <b>🧾 Criar ordem de venda</b> monta a ordem no Odoo com <b>um item por período</b> (produto de horas de consultoria) e <b>um por hora extra</b>; depois, <b>↻ Sincronizar</b> lê o que já foi faturado/pago e mostra <b>o que muda</b> na ordem quando a previsão muda — nada vai para o Odoo antes de você clicar em <b>Aplicar</b>. Item já faturado nunca é alterado. Remover o contrato cancela a ordem.',quando:'Aparece em cada contrato; só gestores criam e aplicam.'},
    {s:'#conteudo [data-pc-xt-add]',ti:'➕ Horas extras',tx:'O processo à parte para as horas fora do combinado: período, descrição, horas, valor-hora, projeto, quem fez e o <b>objeto de resultado</b>. Cada lançamento entra na nota do período e vira um item separado na ordem de venda no próximo ↻ Sincronizar.',quando:'Aparece com a gaveta 🧾 Faturamentos aberta, para gestores.'},
    {s:'#conteudo [data-pc-rt-add]',ti:'🎯 Objetos de resultado',tx:'O rateio padrão de cada nota — ex.: 90% Sumitomo · 10% Hi-Mix — usando as contas analíticas do Odoo (📥 carregue o catálogo). Precisa fechar 100%. O ✎ na linha de um mês define um rateio só daquele período; a hora extra pode ter o seu próprio objeto (100%).',quando:'Aparece com a gaveta 🧾 Faturamentos aberta, para gestores.'},
    {s:'#conteudo .pc-notas',ti:'🧾 Próximas notas',tx:'Todos os contratos, nota por nota: atrasadas e as dos próximos 45 dias, com o estado no Odoo. Uma nota só sai daqui quando o item correspondente é faturado no Odoo — é a garantia de que nenhum faturamento fica esquecido (o 📆 Fechamento do mês da Início mostra o mesmo).',quando:'Aparece quando algum contrato tem equipe alocada ou horas extras.'},
    ...
    {s:'#conteudo [data-pc-plano]',ti:'Planos ligados',tx:'Os planos da 💹 Rentabilidade que usam este contrato — clique para abrir. Desde 2026-09-20 a ordem de venda é do contrato (🧾 Faturamentos); o plano mostra a ordem do contrato quando não tem a sua.',quando:'Aparece quando um plano de horas abertas está ligado ao contrato.'}]},
};
