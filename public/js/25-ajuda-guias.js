...
function abreAjuda(){
  ...
  abreModal(`
    ...
    <details class="help-sec"><summary>TODAS as telas (por grupo do menu — clique para abrir)</summary><div class="help-body"><ul>
      ...
      <li>· <span class="lnk" data-aj-goto="rentab"><b>💹 Rentabilidade de projetos</b></span> — receita por tipo de projeto: horas abertas (início, fim, horas por dia e valor da hora → receita prevista mês a mês e cotação no Odoo), escopo fechado (valor do projeto e marcos de faturamento) e internos (orçamento de custo consumido pela alocação); planeje quem faz o quê por período, simule cenários e compare com o realizado; custo sempre = horas × custo/h de cada pessoa.<button class="aj-g" data-aj-guia="rentab">🧭 guia</button></li>
...
const GUIAS={
  ...
  rentab:{t:'💹 Rentabilidade de projetos',p:[
    ...
    {s:'#conteudo .rp-rec',ti:'Precisão de receita',tx:'Nas horas abertas: receita prevista mês a mês (horas por dia × dias úteis × valor da hora) contra a realizada (horas faturáveis apontadas × valor). Dá para criar a cotação no Odoo com essas linhas.',quando:'Aparece num plano de horas abertas.'},
    {s:'#conteudo [data-rp-odoo]',ti:'Cotação no Odoo',tx:'Cria no módulo de Vendas do Odoo uma cotação em rascunho com uma linha por mês (horas previstas × valor da hora) no cliente do plano — a equipe confirma e fatura lá.',quando:'Aparece para gestores num plano de horas abertas com receita.'},
    ...
    {s:'#conteudo .rp-grade',ti:'Planner visual pessoa × mês',tx:'Cada célula são as horas da pessoa naquele mês (execução ou gestão). Adicione alguém por período — horas por dia útil, por mês ou no total, de um mês até outro. Enter e setas navegam; o Total redistribui pelos meses. O rodapé mostra previsto, vendidas, saldo e o realizado do Clockwork.',quando:'Aparece com um plano aberto.'},
