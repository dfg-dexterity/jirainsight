...
const GUIAS={
  ...
  cronograma:{t:'📅 Marcos e Cronograma',p:[
    ...
    {s:'#conteudo .vg-hero',ti:'Os números do projeto',tx:'Épicos por status, atrasados, em risco, marcos nos próximos 30 dias, progresso geral em itens e o último marco planejado contra a previsão pelo ritmo.',quando:'Aparece quando a ficha do projeto termina de carregar.'},
