...
const GUIAS={
  ...
  rentab:{t:'💹 Rentabilidade de projetos',p:[
    ...
    {s:'#conteudo .rp-rec',ti:'Precisão de receita',tx:'Nas horas abertas: receita prevista mês a mês (horas por dia × dias úteis × valor da hora) contra a realizada (horas faturáveis apontadas × valor).',quando:'Aparece num plano de horas abertas.'},
