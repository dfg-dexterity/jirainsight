...
const GUIAS={
  ...
  cronograma:{t:'📅 Marcos e Cronograma',p:[
    {s:'#cr-proj',ti:'Escolha o projeto',tx:'O cronograma é montado a partir da ficha do projeto no Jira: cada épico vira uma fase. Chegando pela ficha do projeto ou pela Central (R04), o projeto já vem escolhido.'},
